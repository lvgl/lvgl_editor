...
<Cards>
  <Card href="./syntax/components" icon={<Box />}>
    **Components**
...
<Cards>
  ...
  <Card href="./syntax/images" icon={<Image />}>
    **Images**
  ...
  <Card href="./syntax/fonts" icon={<FileText />}>
    **Fonts**
...
<Cards>
  <Card href="./syntax/testing" icon={<TestTube />}>
    **UI Testing**
  ...
  <Card href="./syntax/preview" icon={<Monitor />}>
    **Preview**
