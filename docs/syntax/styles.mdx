...
See [Data-bindings](./syntax/data-binding) for more information.
...
However you can pass [`<api>`](./syntax/api) properties to local style properties:
...
<Callout>
Gradients are not supported yet. The documentation preview is design preview.
</Callout>
