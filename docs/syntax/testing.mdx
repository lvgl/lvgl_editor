...
- **UI Definition**: Use [`<styles>`](./syntax/styles), [`<consts>`](./syntax/constants), and [`<view>`](./syntax/view) to define
 how the UI should look. This is identical to how [`<component>`](./syntax/components)s are
 structured.
