...
The LVGL Editor provides a Node-based command line tool, `lved-cli.js`, for generating and compiling code from XML, validating projects, [syncing from Figma](./figma), comparing trees, and running headless UI tests.
...
Synchronize project with Figma. See [Figma Flow](./figma) for the full plugin workflow.
