...
lv_obj_t * alarm_create(lv_obj_t * parent)
{
    ...
    if (examples_check_target(EXAMPLES_TARGET_ALL)) {
        ...
        lv_obj_set_name(roller_0, "roller_0");
        ...
        lv_obj_set_style_pad_ver(div_1, 12, 0);
        lv_obj_add_style(div_1, &has_border_bottom, 0);
        lv_obj_bind_style(div_1, &settings_dark, 0, &dark_theme, 1);
        ...
        lv_obj_t * lv_label_4 = lv_label_create(div_2);
