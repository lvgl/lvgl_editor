...
lv_obj_t * icon_create(lv_obj_t * parent)
{
    ...
    if (!style_inited) {
        ...
        lv_style_set_width(&main_style, SIZE);
        lv_style_set_height(&main_style, SIZE);
        lv_style_set_image_recolor(&main_style, lv_color_hex(0xffffff));
        lv_style_set_image_recolor_opa(&main_style, 255);
    ...
    lv_obj_add_style(lv_image_0, &main_style, 0);
